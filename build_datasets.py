...
def process_icdar15_detection(icdar_dir, output_crop_dir):
    ...
    gt_dir = os.path.join(icdar_dir, "ch4_training_localization_transcription_gt")
            ...
            for line in f:
                ...
                if len(parts) >= 9:
                    ...
                    try:
                        ...
                        # Add to JSON list
                        dataset.append({"path": os.path.abspath(crop_filepath), "label": label})
                        crop_counter += 1
...
if __name__ == "__main__":
    ...
    unified_data.extend(process_icdar15_detection(icdar_folder, icdar_crops_folder))
    ...
    print(f"Success! {len(unified_data)} total real-world images indexed into {output_file}.")s